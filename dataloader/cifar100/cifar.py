...
class CIFAR10(VisionDataset):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None,
                 download=False, index_path=None, index=None, base_sess=None):
        ...
        if base_sess:
            ...
            if train:
                self.data, self.targets = self.NewClassSelector(self.data, self.targets, index_path)
            else:
                self.data, self.targets = self.SelectfromDefault(self.data, self.targets, index)
    ...
    def NewClassSelector(self, data, targets, index_path):
